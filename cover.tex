...
%Translated abstract, in case your university requires another abstract in the local language
\begin{trabstractpage}
Place your translated abstract here, if you have one. 
% If you want a different title rather than "Abstract" (e.g. Résumé in French), you can change it in tufte-book.cls line 256. Sorry, the parametrization is in the to-do list ^^
\end{trabstractpage}
