...
\sidenote{Yann LeCun, a strong advocate of unsupervised learning, famously introduced the `cake analogy' at NIPS 2016: \textit{``If intelligence is a cake, the bulk of the cake is unsupervised learning, the icing on the cake is supervised learning, and the cherry on the cake is reinforcement learning (RL).''}}
...
HISTORY OF SIMON DIXON'S BALLROOM DATASET, ARTIFACTS
MFCC derivatives; as a whole they tend to to decent job at this task, not interpretable. Some of them are known.
